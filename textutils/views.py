...
def analyzer(request):
    ...
    if text == '':
        messages.warning(request, "Enter The Text on The TextField First...")
        return render(request, 'first.html')
    ...
    if capitalize != 'on' and lower != 'on'and upper != 'on'and change != 'on' and count != 'on' and extraspace != 'on'and newline != 'on'and removep != "on":
        messages.success(
            request, "Please !!! Choose One Of the mention function...... ")
        return render(request, 'first.html')
    ...
    if upper == 'on':
        ...
        params = {'analyzed_text': analyzed,
                  'purpose': "Change The Charracter Into UpperCase"}
        text = analyzed
    ...
    if count == 'on':
        ...
        params = {'analyzed_text': count,
                  'purpose': "Count The Total Character"}
        text = analyzed
    ...
    if change == 'on':
        ...
        params = {'analyzed_text': analyzed,
                  'purpose': "Change the Case of the character"}
        text = analyzed
    if lower == 'on':
        analyzed = ''
        for char in text:
            analyzed = analyzed+char.lower()
        params = {'analyzed_text': analyzed,
                  'purpose': "Change Character into LowerCase"}
        text = analyzed
